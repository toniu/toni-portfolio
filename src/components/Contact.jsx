    ...
    return (
        <div id='contact' className='relative h-auto flex justify-center items-center'>
            <div className="w-4/5 px-5 py-10">
                <p className="text-base md:text-lg font-light text-center md:text-left text-black mb-2">Let's connect. Get in touch with my socials and fill out the form below!</p>
                ...
                <form onSubmit={handleSubmit}
                    ...
                    <div className="mb-4 flex-grow">
                        <label htmlFor="firstName" className="block text-black text-lg text-left">First Name </label>
                    ...
                    <div className="mb-4 flex-grow">
                        <label htmlFor="lastName" className="block text-black text-lg text-left">Last Name</label>
                    ...
                    <div className="w-full mb-4">
                        <label htmlFor="email" className="block text-black text-lg text-left">Email</label>
                    ...
                    <div className="w-full mb-4">
                        <label htmlFor="message" className="block text-black text-lg text-left">Message</label>
