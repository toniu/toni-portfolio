      ...
      >
        ...
        <div className="text-center relative z-10">
          <div className="text-3xl md:text-4xl font-bold mb-4">
            <motion.h2 initial={shouldReduceMotion ? false : { opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={shouldReduceMotion ? { duration: 0 } : { delay: 1.25, duration: 1 }}
              className='text-white select-none'>
              hello, i’m neka
            </motion.h2>
            <span className='text-blue-400 select-none'> toni</span>
            <motion.span initial={shouldReduceMotion ? false : { opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={shouldReduceMotion ? { duration: 0 } : { delay: 1.25, duration: 1 }}
          ...
          <motion.div
            ...
            transition={shouldReduceMotion ? { duration: 0 } : { delay: 1.25, duration: 1 }}
          >
            <p className='select-none text-lg md:text-2xl text-blue-400 font-medium py-12'>Front-end developer</p>
          </motion.div>

          <motion.p
            initial={shouldReduceMotion ? false : { opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={shouldReduceMotion ? { duration: 0 } : { delay: 1.8, duration: 0.8 }}
